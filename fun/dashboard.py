...
class DashboardData:
    ...
    def snapshot(self) -> dict[str, Any]:
        ...
        return {"sessions": len(sessions), "tasks": len(tasks), **totals, **counts, "session_usage": session_rows[:20], "recent": recent[-20:][::-1]}
